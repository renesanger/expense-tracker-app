...
export const deleteTransaction = async (
  ...
  try {
    ...
    if (transactionType == "expense" && newWalletAmount < 0) {
      return { success: true, msg: "You cannot delete this transaction." };
    }
...
export const fetchWeeklyStats = async (uid: string): Promise<ResponseType> => {
  try {
    ...
    console.log("error fetching weekly transaction: ", err);
    return { success: false, msg: err.message };
  }
};
...
export const fetchMonthlyStats = async (uid: string): Promise<ResponseType> => {
  try {
    ...
    console.log("error fetching monthly transaction: ", err);
    return { success: false, msg: err.message };
  }
};
...
export const fetchYearlyStats = async (uid: string): Promise<ResponseType> => {
  try {
    ...
    console.log("error fetching yearly transaction: ", err);
    return { success: false, msg: err.message };
  }
};